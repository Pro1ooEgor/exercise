...
class Class2():  # Класс Class2 наследует класс Class1
    def f_func2(self):
        print("Метод f_func2() класса Class2")


class Class3():  # Класс Class3 наследует класс Class1
    def f_func1(self):
...
class Class4(Class1, Class2, Class3):  # Множественное наследование
    def f_func4(self):
